...
import CVEnglish from "../../Files/Tengku-Davyan-CV-English.pdf";
import CVJapanese from "../../Files/Tengku-Davyan-CV-Japanese.pdf";
import Proud from "../../Images/HeroSection/proud_feeling.svg";
import ReactGA from "react-ga";

// Hero Section Container
const HeroSection = ({ textData, language }) => {
  const { introduction, name, jobIntroduction, job1, lastWord, download } =
    textData;
  return (
    <MainContainer primary={true} id="home">
      <HeroSectionWrap>
        ...
        <Body>
          {" "}
          {/* HalfWrap is used to divide the body into 2 part in horizontal */}
          ...
          <HalfWrap>
            ...
            <DownloadCvButton
              href={language === "eng" ? CVEnglish : CVJapanese}
              download="Tengku Davyan Portfolio"
              onClick={() => {
                ReactGA.event({ category: "User", action: "Download CV" });
              }}
            >
              {download}
            </DownloadCvButton>
